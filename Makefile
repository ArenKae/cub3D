...
SRC = src/main.c src/render.c src/utils.c src/free.c src/free_mlx.c src/file_check.c src/textures.c src/raycaster_1.c src/raycaster_2.c src/movement.c src/file_parsing.c src/map.c src/map_check.c src/key_hook.c src/error.c
