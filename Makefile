...
SRC = src/main.c src/render.c src/utils.c src/free.c src/free_mlx.c src/textures.c src/raycasting.c src/file_parsing.c src/map.c src/map_check.c src/key_hook.c src/error.c
