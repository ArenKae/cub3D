...
SRC = src/main.c src/render.c src/utils_1.c src/utils_memory.c src/textures.c src/raycasting.c src/file_parsing.c src/map.c src/map_check.c src/key_hook.c
